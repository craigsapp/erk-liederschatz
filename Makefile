## erk-liederschatz Makefile
##
## Programmer:    Craig Stuart Sapp <craig@ccrma.stanford.edu>
## Creation Date: Wed Jun  4 18:07:20 PDT 2014
## Last Modified: Wed Jun  4 18:07:28 PDT 2014
## Filename:      Makefile
## Syntax:        GNU/BSD makefile
##
## Description:   Makefile for basic processing Humdrum data files 
##                for the Deutscher Liederschatz, edited by Ludwig Erk.
##
...
#           git clone https://github.com/craigsapp/erk-liederschatz
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://liederschatz)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=liederschatz&file=$$TBASE.krn&format=pdf" \
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/craigsapp/erk-liederschatz[0;31m"
	@echo "[0m"
	exit 1
endif
